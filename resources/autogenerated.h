...
/** \typedef ucxhPARSER_urcEthernetUpEvent_t
 * Event generated upon the reception of the URC `+UUETHLU`
 * \note Some parts of this documentation is automatically generated.
 * \urc +UUETHLU
 * \sa ucxhPARSER_setOnEthernetUp()
 * \sa onUUETHLU_createEvent()
 */

/** \brief Register the callback to invoke upon reception of the `+UUETHLU` URC or command response for `Ethernet Up`
 * The callback is invoked independent of if the URC is received in AT mode or through the EDM AT channel.
 * If no callback is registered, the callback optinally registered with `ucxhPARSER_setOnURCParsed()` will be invoked instead.
 * \note This function is automatically generated.
 * \urc UUETHLU
 * \param [in] callback The callback to invoke upon reception of `+UUETHLU`
 * \param [in] pEvent The event passed to the callback
 * \returns TRUE if registration succeeded, FALSE otherwize.
 * \sa onUUETHLU_createEvent()
 * \sa ucxhPARSER_setOnXUUETHLUError()
 * \sa ucxhPARSER_setOnXXX()
 * \ingroup autogenerated
 */
bool ucxhPARSER_setOnEthernetUp(int (*callback)(ucxhPARSER_urcEthernetUpEvent_t *pEvent));

/** \brief Register the callback to invoke in case the command `AT+UUETHLU` for `Ethernet Up` failed with `ERROR`.
 * The callback is invoked independent of if the URC is received in AT mode or through the EDM AT channel.
 * If no callback is registered, the callback optinally registered with `ucxhPARSER_setOnErrorReceived()` will be invoked instead.
 * \note This function is automatically generated.
 * \urc UUETHLU
 * \cmd AT+UUETHLU
 * \param [in] callback The callback to invoke upon reception of `ERROR` for `AT+UUETHLU`
 * \param [in] _ TBD
 * \returns TRUE if registration succeeded, FALSE otherwize.
 * \sa ucxhPARSER_setOnXXXError()
 * \ingroup autogenerated
 */
bool ucxhPARSER_setOnUUETHLUError(int (*callback)(void *_));

/** \brief Create a struct ucxhPARSER_urcEthernetUpEvent_t from the parameters in a `+UUETHLU` URC.
 * Declaration for a function which parses a line to create an event for a URC or reponse to a command request `EthernetUp`,
 * with the actual URC or command is `UUETHLU`.
 * After this function has been invoked by the parser, the parser will forward the event to whoever registered itself
 * as listener with the function `\ref ucxhPARSER_setOnEthernetUp()`
 * \note The actual definition is NOT autogenerated, and must fulfill the requirements outlined in \ref extending.
 * \note All code required to invoke this function is automatically generated.
 * \param [in] numParams Number of parameters in ppParams, or 0
 * \param [in] ppParams The parameters, or NULL
 ...
 * \ingroup eventcreation
 */
ucxhURC_parseResult_t onUUETHLU_createEvent(uint8_t numParams, const char *ppParams[], ucxhPARSER_urcEthernetUpEvent_t *pEvent);


/** \typedef ucxhPARSER_urcEthernetDownEvent_t
 * Event generated upon the reception of the URC `+UUETHLD`
 * \note Some parts of this documentation is automatically generated.
 * \urc +UUETHLD
 * \sa ucxhPARSER_setOnEthernetDown()
 * \sa onUUETHLD_createEvent()
 */

/** \brief Register the callback to invoke upon reception of the `+UUETHLD` URC or command response for `Ethernet Down`
 * The callback is invoked independent of if the URC is received in AT mode or through the EDM AT channel.
 * If no callback is registered, the callback optinally registered with `ucxhPARSER_setOnURCParsed()` will be invoked instead.
 * \note This function is automatically generated.
 * \urc UUETHLD
 * \param [in] callback The callback to invoke upon reception of `+UUETHLD`
 * \param [in] pEvent The event passed to the callback
 * \returns TRUE if registration succeeded, FALSE otherwize.
 * \sa onUUETHLD_createEvent()
 * \sa ucxhPARSER_setOnXUUETHLDError()
 * \sa ucxhPARSER_setOnXXX()
 * \ingroup autogenerated
 */
bool ucxhPARSER_setOnEthernetDown(int (*callback)(ucxhPARSER_urcEthernetDownEvent_t *pEvent));

/** \brief Register the callback to invoke in case the command `AT+UUETHLD` for `Ethernet Down` failed with `ERROR`.
 * The callback is invoked independent of if the URC is received in AT mode or through the EDM AT channel.
 * If no callback is registered, the callback optinally registered with `ucxhPARSER_setOnErrorReceived()` will be invoked instead.
 * \note This function is automatically generated.
 * \urc UUETHLD
 * \cmd AT+UUETHLD
 * \param [in] callback The callback to invoke upon reception of `ERROR` for `AT+UUETHLD`
 * \param [in] _ TBD
 * \returns TRUE if registration succeeded, FALSE otherwize.
 * \sa ucxhPARSER_setOnXXXError()
 * \ingroup autogenerated
 */
bool ucxhPARSER_setOnUUETHLDError(int (*callback)(void *_));

/** \brief Create a struct ucxhPARSER_urcEthernetDownEvent_t from the parameters in a `+UUETHLD` URC.
 * Declaration for a function which parses a line to create an event for a URC or reponse to a command request `EthernetDown`,
 * with the actual URC or command is `UUETHLD`.
 * After this function has been invoked by the parser, the parser will forward the event to whoever registered itself
 * as listener with the function `\ref ucxhPARSER_setOnEthernetDown()`
 * \note The actual definition is NOT autogenerated, and must fulfill the requirements outlined in \ref extending.
 * \note All code required to invoke this function is automatically generated.
 * \param [in] numParams Number of parameters in ppParams, or 0
 * \param [in] ppParams The parameters, or NULL
 ...
 * \ingroup eventcreation
 */
ucxhURC_parseResult_t onUUETHLD_createEvent(uint8_t numParams, const char *ppParams[], ucxhPARSER_urcEthernetDownEvent_t *pEvent);
